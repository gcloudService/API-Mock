...
6. If you did everything correct, https://gcloudservice.github.io/API-Mock/ will lead to your new docs
...
- Preview spec version for branch `[branch]`: https://gcloudservice.github.io/API-Mock/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://gcloudservice.github.io/API-Mock/ with url from the message: `Server started <url>`
